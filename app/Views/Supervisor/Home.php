            ...
            <div class="row g-0 align-items-center">
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div>
                            Metode <em>Multi Attribute Utility Theory </em>(MAUT)
                        </div>
                        <!-- <a href="javascript:;" class="btn btn-sm btn-primary mt-3"><i class="uil-cog"></i> Setting
                            Account</a> -->
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="card-title mb-2">30</h3>
                        <div class="d-grid gap-2 mx-auto">
                            <a href="javascript:;" class="btn btn-sm btn-info">View More</a>
                        </div>
                    </div>
                </div>
